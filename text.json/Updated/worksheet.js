...
lastAction: this.history[this.history.length - 1] || null
    ...
    this.currentExamConfig = null; // ← add this line
    ...
    generateExaminationPaper() {
        ...
        console.log('🔍 DEBUG - Subject in config:', this.currentExamConfig.subject);
        console.log('🔍 DEBUG - SubjectName in config:', this.currentExamConfig.subjectName);
        console.log('🔍 DEBUG - Topics in config:', this.currentExamConfig.topics);
        console.log('\n' + '='.repeat(80));
