//app/api/workbook/export-png/route.js
...
export async function POST(request) {
  try {
    ...
    const buffer = workbook.exportToPNG(null, {
      ...
      includeBiochemicalDiagrams:    options.includeBiochemicalDiagrams    || false
    })
    ...
    return new NextResponse(buffer, {
      ...
      headers: {
        ...
        'Content-Disposition': `attachment; filename="workbook-${Date.now()}.png"`,
