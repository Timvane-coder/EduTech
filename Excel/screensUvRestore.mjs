...
const ORIGINAL = './models/ramenShop_uvrestored_v2_lifted.glb'
const MODIFIED = './models/ramenShopExhibtStand_with_hallway.glb'   // ← your actual filename
...
const outFile = './models/ramenShopExhibtStand_with_hallway.glb'
