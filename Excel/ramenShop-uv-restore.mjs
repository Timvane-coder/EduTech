...
const MODIFIED_FILE = './models/ramenShop_split_chunked.glb'   // merged file with lost UVs
...
const TARGET_NAMES = new Set([
  ...
  'portalLight', 'projectsRed', 'projectsWhite', 'redLED', 'roof', 'sideScreen',
  'smallScreen1', 'smallScreen2', 'smallScreen3', 'smallScreen4', 'smallScreen5',
  'storageLight', 'tallScreen', 'tvScreen', 'vendingMachineLight',
