...
handleProteins(problem) {
        ...
        const content = {
            ...
            factorsAffectingActivity: {
                ...
                pH: {
                    ...
                    extremes: {
                        toolow: "Protonates carboxyl groups, alters charges, may denature",
                        toohigh: "Deprotonates amino groups, alters charges, may denature"
                    }
                },
                substrateConcentration: {
   ...
   async generateMolecularDiagramData() {
        ...
        this.diagramData = {
            ...
            renderedImages: [],
            placeholder: false,
            note: "Molecular biology diagrams rendered"
        };

        // Render diagrams if enabled
        if (this.includeDiagramsInWorkbook && diagramKeys.length > 0) {
    ...
    getRelevantMolecularDiagrams(topicType) {
        const diagramMap = {
            carbohydrates: [
                "glucose_structure",
                "alpha_vs_beta_glucose",
                "disaccharide_formation",
                "starch_vs_cellulose",
                "polysaccharide_structures",
                "haworth_projection"
            ],
            lipids: [
                "triglyceride_structure",
            ...
            enzymes: [
                "enzymeAction",
                "enzymeAction", // Lock and key / induced fit would use this
                "enzymeAction"  // Michaelis-Menten would be custom
            ],
            molecular_signaling: [
                "cellMembrane",
                "cellMembrane" // Receptor signaling diagrams
            ],
            glycobiology: [
                "cellMembrane",
                "antibodyStructure"
