...
export class EnhancedCellularDivisionWorkbook {
            ...
            mitosis: {
                ...
                spindle: {
                    components: {
                        ...
                        spindle poles: "Ends of spindle (centrosomes or spindle pole bodies)",
                        microtubules: {
    ...
    // ========================================
            ...
            walther_flemming_mitosis: {
                name: "Walther Flemming's Observation of Mitosis - The Discovery of Chromosomes in Action",
                relatedTopics: ['mitosis', 'chromosome_structure', 'cell_cycle'],
                category: 'cell_division',
                historicalBackground: {
                    scientist: "Walther Flemming",
                    year: "1879-1882",
                    contribution: "First detailed description of mitosis and chromosome behavior during cell division",
                    context: "Before Flemming, cell division was poorly understood. He used newly developed aniline dyes to visualize 'colored bodies' (chromatin/chromosomes) in dividing salamander cells",
                    significance: "Established that chromosomes are the carriers of hereditary information and undergo precise distribution during division",
                    quote: "The splitting of the threads is a fundamental process in cell division",
                    discovery: "Coined the term 'mitosis' (from Greek mitos = thread) and 'chromatin'",
                    technique: "Used aniline dyes (safranin, hematoxylin) on salamander larvae tissue - first to clearly visualize chromosomes",
                    publications: "Zellsubstanz, Kern und Zelltheilung (Cell Substance, Nucleus and Cell Division, 1882)",
                    impact: "Laid foundation for understanding heredity, connecting cell division to inheritance",
                    contemporaries: "Eduard Strasburger (plant mitosis), Eduard van Beneden (chromosome constancy)"
                },
                labExperiment: {
                    title: "Observing Mitosis in Onion Root Tip Cells",
                    hypothesis: "If actively dividing cells are observed, then different stages of mitosis (prophase, metaphase, anaphase, telophase) will be visible as predicted by Flemming's descriptions",
                    purpose: "Visualize and identify the stages of mitosis in plant cells using microscopy and staining techniques",
                    background: {
                        whyOnionRoots: "Root tips contain meristematic tissue with rapidly dividing cells (~24 hour cell cycle)",
                        activeZone: "Region of cell division located 2-5 mm from root tip",
                        staining: "Acetocarmine or acetoorcein stains chromatin (DNA) dark red/purple",
                        fixation: "Preserves cell structure and stops division at current stage"
                    },
                    variables: {
                        independent: "Time of fixation (to capture different stages)",
                        dependent: "Frequency of cells in each mitotic stage observed",
                        controlled: ["Root tip source (same onion)", "Stain type and concentration", "Fixative type", "Observation time", "Microscope magnification"]
                    },
                    materials: [
                        "Fresh onion bulbs with actively growing roots (2-3 cm long)",
                        "Carnoy's fixative (3:1 ethanol:glacial acetic acid) or 70% ethanol",
                        "1M HCl (hydrochloric acid)",
                        "Acetocarmine or acetoorcein stain",
                        "Distilled water",
                        ...
                        "Water bath or beaker with hot water (60°C)",
                        "Dropper or pipette",
                        "Pencil and eraser (for gentle squashing)"
                    ],
                    safetyPrecautions: [
                        "Wear safety goggles and gloves when handling acids and fixatives",
                        "Carnoy's fixative and HCl are corrosive - handle with care",
                        "Work in well-ventilated area (fume hood if available)",
                        "Acetocarmine/acetoorcein can stain skin and clothing",
                        "Dispose of chemicals properly according to local regulations",
                        "Handle microscope slides carefully to avoid cuts",
                        "Be cautious with hot water bath"
                    ],
                    procedure: [
                        "PREPARATION OF ONION ROOTS:",
                        "Grow onion roots by placing onion bulb over water in a jar",
                        "Wait until roots are 2-3 cm long (3-5 days)",
                        "Harvest 5-10 root tips in the morning (9-11 AM) when mitotic activity is highest",
                        "",
                        "FIXATION:",
                        "Cut root tips (~5 mm from tip) with sharp scalpel",
                        "Immediately place root tips in Carnoy's fixative or 70% ethanol",
                        "Fix for 24 hours at room temperature (preserves cell structure, stops division)",
                        "Fixative hardens proteins and stops enzymatic activity",
                        "",
                        "HYDROLYSIS (Softening):",
                        "Remove root tips from fixative and rinse with distilled water",
                        "Place root tips in 1M HCl at 60°C for 4-8 minutes",
                        "This hydrolyzes pectin in cell walls, allowing cells to separate",
                        "Rinse thoroughly with distilled water (2-3 changes)",
                        "",
                        "STAINING:",
                        "Place one root tip on a clean microscope slide",
                        "Add 1-2 drops of acetocarmine or acetoorcein stain",
                        "Let stain for 2-5 minutes (chromosomes will absorb stain)",
                        "Stain binds to DNA in chromosomes, making them visible",
                        "",
                        "SQUASHING (Preparation):",
                        "Carefully cut off and discard the upper part of root (keep only 2 mm from tip)",
                        "Add a coverslip over the stained root tip",
                        "Place a folded paper towel over the coverslip",
                        "Press down gently but firmly with thumb to squash the tissue",
                        "This spreads cells into a single layer for observation",
                        "Alternative: Tap gently with pencil eraser for controlled squashing",
                        "Avoid sideways movement (will shear cells)",
                        "",
                        "OBSERVATION:",
                        "Examine slide under low power (10x objective) to locate cells",
                        "Switch to high power (40x objective) for detailed observation",
                        "Scan the slide systematically",
                        "Identify and count cells in each stage: interphase, prophase, metaphase, anaphase, telophase",
                        "Look for characteristic features of each stage",
                        "Draw representative cells from each stage",
                        "Take photographs if microscope camera available",
                        "",
                        "DATA COLLECTION:",
                        "Count at least 100-200 cells total",
                        "Record number of cells in each stage",
                        "Calculate percentage of cells in each stage",
                        "This gives estimate of relative time spent in each phase"
                    ],
                    observations: {
                        interphase: {
                            appearance: "Nucleus clearly visible with distinct nuclear membrane",
                            chromatin: "Diffuse, thread-like, lightly stained (not condensed)",
                            nucleolus: "One or two dark-staining nucleoli present",
                            frequency: "~90-95% of cells (most time spent here)",
                            note: "Not technically part of mitosis, but most common stage observed"
                        },
                        prophase: {
                            appearance: "Chromatin condensing into visible chromosomes",
                            chromosomes: "Thick, dark-staining threads, tangled appearance, individual chromosomes starting to become distinct",
                            nucleus: "Nuclear membrane starting to break down (late prophase)",
                            nucleolus: "Disappearing",
                            frequency: "~3-5% of cells",
                            duration: "Longest stage of mitosis",
                            visualCue: "Chromosomes visible but not yet aligned"
                        },
                        metaphase: {
                            appearance: "Chromosomes aligned at cell equator (metaphase plate)",
                            chromosomes: "Maximally condensed, very dark staining, line across middle of cell",
                            structure: "Each chromosome = two sister chromatids joined at centromere",
                            clarity: "Clearest stage to see individual chromosomes and count them",
                            frequency: "~1-2% of cells",
                            visualCue: "Chromosomes in a straight line across center",
                            ideal: "Best stage for karyotyping and chromosome counts"
                        },
                        anaphase: {
                            appearance: "Sister chromatids separating and moving to opposite poles",
                            chromosomes: "V-shaped or Y-shaped as centromeres lead, arms trail",
                            movement: "Two distinct groups of chromosomes moving apart",
                            cell: "May appear elongated",
                            frequency: "~0.5-1% of cells (very brief stage)",
                            visualCue: "Chromosomes at opposite ends, cell elongating"
                        },
                        telophase: {
                            appearance: "Two groups of chromosomes at opposite poles",
                            chromosomes: "Beginning to decondense (become lighter staining)",
                            nucleus: "Nuclear membranes reforming around chromosome groups",
                            cellPlate: "In plant cells, cell plate forming between daughter nuclei (visible as line)",
                            cytokinesis: "Cell plate growing outward to divide cytoplasm",
                            frequency: "~1-2% of cells",
                            visualCue: "Two nuclei forming, cell dividing in middle"
                        },
                        cytokinesis: {
                            plant: "Cell plate visible as dark line between daughter cells",
                            completion: "New cell wall forming",
                            result: "Two daughter cells with identical nuclei"
                        }
                    },
                    expectedResults: {
                        typicalDistribution: {
                        ...
                        explanation: "Percentage reflects relative time spent in each phase",
                        mitotic_index: {
                            calculation: "(Number of cells in mitosis / Total cells counted) × 100",
                            typical: "5-10% in root tip meristem",
                            meaning: "Indicates how actively tissue is dividing"
                        }
                    },
                    dataTable: [
                        ["Stage", "Number of Cells", "Percentage", "Characteristics Observed"],
                        ["Interphase", "185", "92.5%", "Distinct nucleus, diffuse chromatin"],
                        ["Prophase", "8", "4.0%", "Condensing chromosomes, nucleus fading"],
                        ["Metaphase", "3", "1.5%", "Chromosomes aligned at center"],
                        ["Anaphase", "1", "0.5%", "Chromatids moving to poles"],
                        ["Telophase", "3", "1.5%", "Two nuclei forming, cell plate visible"],
                        ["TOTAL", "200", "100%", ""],
                        ["Mitotic Index", "15/200", "7.5%", ""]
                    ],
                    analysis: {
                        interpretation: [
                            "Most cells in interphase because it's the longest phase (90% of cell cycle)",
                            "Prophase is longest mitotic stage (chromosomes condensing takes time)",
                            "Anaphase is very brief (chromosome separation happens quickly)",
                            "Mitotic index indicates actively dividing tissue",
                            "Distribution of stages reflects cell cycle timing"
                        ],
                        calculations: {
                            cellCycleDuration: "Assume 24-hour cell cycle for onion root tip",
                            mitosis: "If 7.5% cells in mitosis: 0.075 × 24h = 1.8 hours for mitosis",
                            interphase: "92.5% → 0.925 × 24h = 22.2 hours",
                            prophase: "4% of 1.8h = 0.072h = ~4 minutes (example)"
                        },
                        variation: "Percentages vary depending on growth conditions, time of day, temperature"
                    },
                    connectionToFlemming: {
                        technique: "Modern adaptation of Flemming's original staining method",
                        observations: "We see the same chromosome behavior Flemming described in 1882",
                        terminology: "Flemming's names (mitosis, chromatin, prophase, etc.) still used today",
                        significance: "Flemming's meticulous observations were accurate - confirmed by modern microscopy"
                    },
                    molecularExplanation: {
                        prophase: "Condensin proteins compact chromatin; MPF triggers nuclear envelope breakdown",
                        metaphase: "Kinetochores attach to spindle; spindle checkpoint delays anaphase until all attached",
                        anaphase: "APC/C degrades securin → separase cleaves cohesin → sister chromatids separate",
                        telophase: "Cyclin degradation → exit from mitosis; nuclear envelope reforms"
                    },
                    results: "Observation of all mitotic stages confirms Flemming's descriptions. The percentage of cells in each stage reflects the relative duration of that stage in the cell cycle.",
                    conclusions: [
                        "Mitosis is a continuous process divided into distinct stages based on chromosome appearance",
                        "Chromosomes undergo precise movements ensuring equal distribution to daughter cells",
                        "The majority of cell cycle time is spent in interphase, not mitosis",
                        "Plant cells use cell plate formation for cytokinesis (unlike animal cells)",
                        "Flemming's 140-year-old observations remain accurate and foundational to cell biology"
                    ],
                    realWorldApplications: [
                        "Cancer diagnosis: Identify abnormal mitotic figures in tissue biopsies",
                        "Plant breeding: Identify polyploid cells (extra chromosome sets)",
                        "Toxicology: Test chemicals for effects on cell division (mitotic poisons)",
                        "Education: Classic demonstration of cell division",
                        "Research: Study effects of drugs on mitosis (chemotherapy development)"
                    ],
                    extensions: [
                        "Compare mitotic index in different tissues (root vs stem)",
                        "Test effects of temperature on mitotic activity",
                        "Examine effects of colchicine (blocks spindle, arrests at metaphase)",
                        "Compare plant and animal mitosis (use whitefish blastula slides)",
                        "Investigate circadian rhythms in mitotic activity (sample at different times)",
                        "Create time-lapse video of dividing cells (if live cell imaging available)"
                    ],
                    limitations: [
                        "Fixed cells - not observing live division (snapshots, not movies)",
                        "Squashing may distort some cells",
                        "2D view of 3D process",
                        "Cannot observe dynamic processes (chromosome movement in real time)",
                        "Subjective classification of stages (borderline cases)"
                    ],
                    troubleshooting: [
                        "No dividing cells visible: Roots may be too old; use actively growing tips",
                        "Cells not separating: HCl hydrolysis too short; increase to 8-10 minutes",
                        "Chromosomes too light: Stain longer or use fresh stain",
                        "Cells too dark: Over-stained; rinse briefly with water",
                        "Overlapping cells: Squash more firmly or use only very tip of root"
                    ],
                    modernAdaptations: {
                        fluorescenceMicroscopy: "GFP-tagged tubulin shows spindle in live cells",
                        confocal: "3D reconstruction of mitotic spindle",
                        liveCellImaging: "Timelapse shows chromosome dynamics in real time",
                        immunofluorescence: "Antibodies against specific mitotic proteins"
                    }
                }
            },

            // ========================================
            // MEIOSIS AND CROSSING OVER EXPERIMENT
            // ========================================

            thomas_hunt_morgan_crossingover: {
                name: "Thomas Hunt Morgan's Evidence for Crossing Over - Fruit Fly Genetic Recombination",
                relatedTopics: ['meiosis', 'chromosome_structure', 'gametogenesis'],
                category: 'genetics_cell_division',
                historicalBackground: {
                    scientist: "Thomas Hunt Morgan",
                    year: "1910-1915",
                    collaborators: "Calvin Bridges, Alfred Sturtevant, Hermann Muller (the 'Fly Room' at Columbia University)",
                    contribution: "Provided first experimental evidence that genes are on chromosomes and that crossing over occurs during meiosis",
                    context: "Mendel's laws were rediscovered in 1900, but the physical basis of heredity was unknown. Morgan's work linked chromosomes to genes",
                    discovery: {
                        1910: "White-eyed mutation in Drosophila - proved genes on chromosomes (sex-linkage)",
                        1911: "Gene linkage discovered (genes on same chromosome inherited together)",
                        1913: "Crossing over explains incomplete linkage and creates genetic maps"
                    },
                    significance: "Established chromosome theory of inheritance; showed genetic recombination occurs via crossing over in meiosis",
                    nobelPrize: "1933 Nobel Prize in Physiology or Medicine",
                    quote: "The fundamental feature of the mechanism is the linear order of the genes",
                    technique: "Drosophila melanogaster (fruit fly) - short generation time (10 days), many offspring, few chromosomes (4 pairs), easy to culture",
                    keyExperiment: "Crosses involving linked genes showed recombination frequency proportional to distance between genes",
                    stuartevant: "Undergraduate student Alfred Sturtevant created first genetic map (1913) based on recombination frequencies"
                },
                labExperiment: {
                    title: "Modeling Crossing Over and Recombination in Meiosis",
                    hypothesis: "If crossing over occurs between homologous chromosomes during meiosis I, then offspring can have new combinations of alleles (recombinant phenotypes) not present in either parent",
                    purpose: "Understand how crossing over during meiosis generates genetic diversity through recombination",
                    background: {
                        crossingOver: "Exchange of DNA segments between homologous chromosomes in prophase I",
                        chiasma: "Visible point where crossing over occurred",
                        recombination: "Production of offspring with new allele combinations",
                        linkage: "Genes on same chromosome tend to be inherited together",
                        incompleteLinkage: "Crossing over can separate linked genes, producing recombinants",
                        recombinationFrequency: "Percentage of recombinant offspring; proportional to distance between genes"
                    },
                    variables: {
                        independent: "Distance between genes on chromosome (simulated)",
                        dependent: "Frequency of recombinant gametes produced",
                        controlled: ["Number of meiotic events modeled", "Crossing over probability", "Starting genotypes"]
                    },
                    materials: [
                        "Pipe cleaners or yarn (2 colors) to represent homologous chromosomes",
                        "Beads or markers (2-3 colors) to represent different genes/alleles",
                        "Tape or glue",
                        "Scissors",
                        "Paper and pencil for recording",
                        "Dice (optional - to randomize crossing over)",
                        "Large paper or poster board for displaying meiotic stages",
                        "Colored pencils or markers"
                    ],
                    safetyPrecautions: [
                        "Be careful with scissors",
                        "No specific hazards with this modeling activity"
                    ],
                    procedure: [
                        "PART 1: MODELING CHROMOSOMES AND ALLELES",
                        "",
                        "Create homologous chromosome models:",
                        "Take two pipe cleaners of different colors (e.g., red and blue) ~30 cm long",
                        "Red pipe cleaner = maternal chromosome",
                        "Blue pipe cleaner = paternal chromosome",
                        "",
                        "Mark genes on chromosomes:",
                        "Choose 2-3 genes to track (e.g., body color, wing type, eye color)",
                        "Use different colored beads for different alleles:",
                        "  Gene A: Yellow bead = dominant allele (B), Orange bead = recessive allele (b)",
                        "  Gene B: Green bead = dominant allele (V), White bead = recessive allele (v)",
                        "",
                        "Position beads on chromosomes:",
                        "Maternal (red): Yellow bead at 10 cm, Green bead at 25 cm (genotype: BV)",
                        "Paternal (blue): Orange bead at 10 cm, White bead at 25 cm (genotype: bv)",
                        "Beads represent alleles at specific loci (gene positions)",
                        "",
                        "PART 2: MEIOSIS I - CROSSING OVER",
                        "",
                        "Prophase I: Synapsis and Crossing Over",
                        "Place the two chromosomes (red and blue) side by side (synapsis)",
                        "This represents bivalent formation (paired homologous chromosomes)",
                        "",
                        "Simulate crossing over:",
                        "Choose a point between the two genes (e.g., at 17-18 cm)",
                        "Mark this as the crossover point (chiasma)",
                        "Cut both pipe cleaners at this point",
                        "Exchange the distal segments (past the cut) between chromosomes:",
                        "  Red: Keep proximal segment (0-17 cm with yellow bead) + attach blue distal segment (18-30 cm with white bead)",
                        "  Blue: Keep proximal segment (0-17 cm with orange bead) + attach red distal segment (18-30 cm with green bead)",
                        "Tape or twist together to form recombinant chromosomes",
                        "",
                        "Result after crossing over:",
                        "Recombinant 1 (red-blue): Yellow bead + White bead (genotype: Bv)",
                        "Recombinant 2 (blue-red): Orange bead + Green bead (genotype: bV)",
                        "",
                        "PART 3: COMPLETING MEIOSIS",
                        "",
                        "Metaphase I and Anaphase I:",
                        "Homologous chromosomes separate (take recombinant chromosomes to opposite poles)",
                        "Each cell receives one recombinant chromosome",
                        "",
                        "Meiosis II:",
                        ...
                        "PART 4: GAMETE TYPES",
                        "",
                        "Without crossing over, possible gametes:",
                        "BV (parental type - from maternal)",
                        "bv (parental type - from paternal)",
                        "",
                        "With crossing over (as modeled):",
                        "BV (parental)",
                        "bv (parental)",
                        "Bv (recombinant)",
                        "bV (recombinant)",
                        "",
                        "PART 5: SIMULATING MULTIPLE MEIOTIC EVENTS",
                        "",
                        "Repeat the process 20 times:",
                        "For each trial, roll a die to determine if crossing over occurs:",
                        "  Roll 1-3: No crossing over → gametes are BV and bv only",
                        "  Roll 4-6: Crossing over occurs → gametes include Bv and bV",
                        "",
                        "Record results:",
                        "Count how many of each gamete type produced:",
                        "  Parental gametes: BV and bv",
                        "  Recombinant gametes: Bv and bV",
                        "",
                        "Calculate recombination frequency:",
                        "RF = (Number of recombinant gametes / Total gametes) × 100",
                        "",
                        "PART 6: DISTANCE AND RECOMBINATION",
                        "",
                        "Vary gene distance:",
                        "Trial A: Genes close together (beads at 10 cm and 12 cm) → Low crossing over probability",
                        "Trial B: Genes far apart (beads at 5 cm and 28 cm) → High crossing over probability",
                        "",
                        "Simulate and compare recombination frequencies:",
                        "Closer genes → lower recombination frequency",
                        "Farther genes → higher recombination frequency (maximum ~50% if on different chromosomes or very far)"
                    ],
                    observations: {
                        withoutCrossingOver: {
                            gametes: "Only parental types (BV and bv)",
                            genetics: "Complete linkage - genes inherited together",
                            offspring: "No new combinations"
                        },
                        withCrossingOver: {
                            gametes: "Parental types (BV, bv) + Recombinant types (Bv, bV)",
                            genetics: "Incomplete linkage - some genes separated by crossing over",
                            offspring: "New combinations of alleles",
                            frequency: "Depends on distance between genes"
                        },
                        geneDistance: {
                            close: "Low recombination frequency (~5-10%)",
                            intermediate: "Moderate recombination frequency (~20-30%)",
                            far: "High recombination frequency (up to ~50%)"
                        }
                    },
                    expectedResults: {
                        simulation: {
                            trials: "20 meiotic events",
                            crossingOverRate: "50% (based on dice roll 4-6)",
                            expectedGametes: {
                                BV: "25% (parental)",
                                bv: "25% (parental)",
                                Bv: "25% (recombinant)",
                            ...
                            recombinationFrequency: "50% (genes far apart or independent assortment)"
                        }
                    },
                    dataTable: [
                        ["Trial", "Crossing Over?", "Gametes Produced", "Parental", "Recombinant"],
                        ["1", "No", "BV, bv, BV, bv", "4", "0"],
                        ["2", "Yes", "Bv, bV, Bv, bV", "0", "4"],
                        ["3", "No", "BV, bv, BV, bv", "4", "0"],
                        ["4", "Yes", "Bv, bV, Bv, bV", "0", "4"],
                        ["5", "Yes", "Bv, bV, Bv, bV", "0", "4"],
                        ["...", "...", "...", "...", "..."],
                        ["20", "No", "BV, bv, BV, bv", "4", "0"],
                        ["TOTAL", "10 yes, 10 no", "", "40", "40"],
                        ["Recombination Frequency", "", "", "", "40/80 = 50%"]
                    ],
                    analysis: {
                        interpretation: [
                            "Crossing over creates new allele combinations not present in parents",
                            "Recombination frequency reflects distance between genes",
                            "Maximum recombination frequency is 50% (genes very far apart or on different chromosomes)",
                            "Genes close together have low recombination frequency (rarely separated by crossing over)",
                            "Crossing over occurs in prophase I of meiosis I (between homologous chromosomes)"
                        ],
                        geneMapping: {
                            principle: "Recombination frequency (in %) = map distance in centiMorgans (cM)",
                            example: "15% recombination = 15 map units (15 cM) apart",
                            usage: "Morgan's group created first genetic maps using this principle"
                        },
                        realData: {
                            drosophila: "Morgan observed recombination frequencies between linked genes",
                            bodyColor_wingType: "17% recombination",
                            bodyColor_eyeColor: "9% recombination",
                            wingType_eyeColor: "9.5% recombination",
                            conclusion: "eyeColor between bodyColor and wingType on chromosome (linear order)"
                        }
                    },
                    connectionToMorgan: {
                        observation: "Morgan noticed some gene combinations appeared less frequently than expected if genes assorted independently",
                        explanation: "Genes on same chromosome are linked, but crossing over occasionally separates them",
                        evidence: "Frequency of recombinants proportional to distance between genes on chromosome",
                        impact: "Proved genes arranged linearly on chromosomes; enabled genetic mapping"
                    },
                    molecularExplanation: {
                        prophaseI: {
                            synapsis: "Homologous chromosomes pair via synaptonemal complex",
                            recombination: "SPO11 enzyme creates double-strand breaks in DNA",
                            repair: "Homologous recombination repairs breaks using homolog as template",
                            crossover: "Some repair events result in crossover (exchange of DNA)",
                            chiasmata: "Physical connection holding homologs together until anaphase I"
                        },
                        frequency: "At least one crossover per chromosome pair (usually 2-3)",
                        distribution: "Crossovers not random - interference prevents nearby crossovers"
                    },
                    results: "Modeling demonstrates that crossing over generates recombinant gametes with new allele combinations. Recombination frequency depends on distance between genes, confirming Morgan's observations.",
                    conclusions: [
                        "Crossing over occurs during prophase I of meiosis between homologous chromosomes",
                        "Recombination creates genetic diversity by producing new allele combinations",
                        "Genes close together on a chromosome are rarely separated by crossing over (tight linkage)",
                        "Genes far apart are frequently separated (loose linkage or independent assortment)",
                        "Recombination frequency allows calculation of gene distances and creation of genetic maps",
                        "Morgan's work established the chromosomal basis of heredity"
                    ],
                    realWorldApplications: [
                        "Genetic mapping of disease genes in humans",
                        "Breeding programs in agriculture (combine desirable traits)",
                        "Understanding evolution (recombination increases genetic variation)",
                        "Prenatal genetic testing (linkage analysis)",
                        "Forensic genetics (linkage disequilibrium patterns)",
                        "Genome-wide association studies (GWAS)"
                    ],
                    extensions: [
                        "Model double crossovers (two crossing over events on same chromosome pair)",
                        "Investigate three-point crosses (three genes) to order genes",
                        "Examine interference (one crossover reduces probability of nearby crossover)",
                        "Compare recombination rates in males vs females (varies by organism)",
                        "Simulate independent assortment (genes on different chromosomes - always 50%)",
                        "Research modern recombination: meiotic recombination hotspots in human genome"
                    ],
                    limitations: [
                        "Physical model simplifies complex molecular process",
                        "Does not show molecular mechanism (DNA strand exchange)",
                        "Crossing over probability simplified (actual process more complex)",
                        "Does not model multiple simultaneous crossovers or interference"
                    ],
                    modernTechniques: {
                        cytology: "Visualize chiasmata in meiotic spreads (still done today)",
                        molecularMarkers: "SNPs and microsatellites track recombination in pedigrees",
                        wholeGenomeSequencing: "Directly identify recombination breakpoints",
                        populationGenetics: "Linkage disequilibrium reveals historical recombination"
                    }
                }
            },

            // ========================================
            // CELL CYCLE CHECKPOINTS EXPERIMENT
            // ========================================

            hartwell_nurse_cellcycle: {
                name: "Hartwell and Nurse's Cell Cycle Mutants - Discovery of Cell Cycle Control",
                relatedTopics: ['cell_cycle', 'cell_cycle_regulation', 'mitosis'],
                category: 'cell_cycle_regulation',
                historicalBackground: {
                    scientists: "Leland Hartwell, Paul Nurse, Tim Hunt",
                    year: "1970s-1990s",
                    contribution: "Identified key regulators of cell cycle: cyclins and cyclin-dependent kinases (CDKs)",
                    context: "Before this work, how cells controlled division timing was a mystery",
                    hartwell: {
                        organism: "Saccharomyces cerevisiae (budding yeast)",
                        approach: "Isolated temperature-sensitive mutants that arrested at specific cell cycle stages",
                        discovery: "CDC (Cell Division Cycle) genes - identified ~100 genes controlling cell cycle",
                        keyGene: "CDC28 (yeast CDK) - required to pass START (G1/S transition)",
                        year: "1970-1974"
                    },
                    nurse: {
                        organism: "Schizosaccharomyces pombe (fission yeast)",
                        discovery: "cdc2 gene (CDK1 homolog) - master regulator of cell cycle",
                        breakthrough: "Showed CDC28 (yeast) and cdc2 (fission yeast) are functionally equivalent",
                        universality: "Human CDK1 can rescue yeast cdc2 mutants - conserved across all eukaryotes",
                        year: "1975-1987"
                    },
                    hunt: {
                        organism: "Sea urchin embryos",
                        discovery: "Cyclins - proteins that oscillate during cell cycle",
                        observation: "Cyclins synthesized and destroyed each cell cycle",
                        connection: "Cyclins activate CDKs → cyclin-CDK complexes drive cell cycle",
                        year: "1982-1983"
                    },
                    nobelPrize: "2001 Nobel Prize in Physiology or Medicine (Hartwell, Nurse, Hunt)",
                    significance: "Revealed universal mechanism of cell cycle control; critical for understanding cancer",
                    quote: "The cell cycle is controlled by a series of checkpoints" - Hartwell
                },
                labExperiment: {
                    title: "Effect of Cell Cycle Inhibitors on Mitotic Index in Onion Root Tips",
                    hypothesis: "If cell cycle checkpoints are disrupted by specific inhibitors, then cells will arrest at predictable stages, changing the distribution of cells in different phases",
                    purpose: "Investigate how cell cycle checkpoints work by observing effects of chemical inhibitors on mitosis",
                    background: {
                        checkpoints: "G1/S, G2/M, and M (spindle) checkpoints control cell cycle progression",
                        inhibitors: {
                            hydroxyurea: "Blocks DNA synthesis (S phase) by inhibiting ribonucleotide reductase",
                            colchicine: "Blocks spindle formation (arrests at metaphase) by preventing tubulin polymerization",
                            caffeine: "Inhibits ATM/ATR kinases (bypasses G2/M checkpoint)",
                            aphidicolin: "Inhibits DNA polymerase (arrests in S phase)"
                        },
                        mitoticIndex: "Percentage of cells in mitosis - indicates proliferation rate"
                    },
                    variables: {
                        independent: "Type and concentration of cell cycle inhibitor",
                        dependent: "Mitotic index and distribution of cells in cell cycle stages",
                        controlled: ["Onion variety", "Root length", "Incubation time", "Temperature", "Staining procedure"]
                    },
                    materials: [
                        "Onion bulbs with growing roots",
                        "Distilled water",
                        "Cell cycle inhibitors:",
                        "  - Colchicine solution (0.05% - 0.1%)",
                        "  - Hydroxyurea solution (10 mM)",
                        "  - Caffeine solution (5 mM) [optional]",
                        "Small beakers or test tubes",
                        "Fixative (Carnoy's: 3:1 ethanol:acetic acid)",
                        "1M HCl",
                        "Acetocarmine or acetoorcein stain",
                        "Microscope slides and coverslips",
                        "Compound microscope",
                    ...
                    safetyPrecautions: [
                        ...
                        "Colchicine is HIGHLY TOXIC - handle with extreme care, use only in fume hood if possible",
                        "Hydroxyurea is a hazardous chemical - avoid skin contact",
                        "Caffeine in high concentrations can be toxic",
                        "Dispose of all chemicals properly",
                        "Wash hands thoroughly after experiment",
                        "HCl and fixative are corrosive"
                    ],
                    procedure: [
                        "EXPERIMENTAL SETUP:",
                        "",
                        ...
                        "Group 2: Colchicine treatment (0.05% - 0.1%)",
                        "Group 3: Hydroxyurea treatment (10 mM)",
                        "Group 4: Caffeine treatment (5 mM) [optional]",
                        "",
                        "Use onions with actively growing roots (2-3 cm)",
                        "Label beakers for each treatment group",
                        "",
                        "TREATMENT:",
                        "",
                        "Place onion bulbs over beakers with appropriate solution:",
                        "Ensure root tips are submerged in solution",
                        "Incubate for 6-24 hours (longer for hydroxyurea, shorter for colchicine)",
                        "Colchicine: 3-6 hours",
                        "Hydroxyurea: 12-24 hours",
                        "Caffeine: 6-12 hours",
                        "",
                        "HARVESTING AND PREPARATION:",
                        "",
                        "After treatment, harvest root tips (5 mm from tip)",
                        "Fix immediately in Carnoy's fixative (24 hours)",
                        "Process for microscopy (same as Flemming experiment):",
                        "  - Hydrolyze in 1M HCl at 60°C for 5-8 minutes",
                        "  - Rinse with distilled water",
                        "  - Stain with acetocarmine",
                        "  - Squash preparation",
                        "",
                        "OBSERVATION AND DATA COLLECTION:",
                        "",
                        "For each treatment group:",
                        "Count at least 200 cells per slide (use 3 slides per treatment)",
                        "Record number of cells in:",
                        "  - Interphase",
                        "  - Prophase",
                        "  - Metaphase",
                        "  - Anaphase",
                        ...
                        "Calculate percentage in each stage",
                        "Note any abnormalities (e.g., C-mitosis from colchicine)",
                        "",
                        "ANALYSIS:",
                        "",
                        "Compare mitotic index across treatments",
                        "Compare distribution of stages across treatments",
                        "Identify which checkpoint is affected by each inhibitor",
                        "Photograph representative cells from each treatment"
                    ],
                    observations: {
                        control: {
                            mitoticIndex: "5-10% (typical for actively dividing root tip)",
                            distribution: "Normal: Interphase ~90%, Prophase ~3-5%, Metaphase ~1-2%, Anaphase ~0.5-1%, Telophase ~1-2%",
                            appearance: "Normal mitotic figures, clear spindles"
                        },
                        colchicine: {
                            effect: "Arrests cells at metaphase (spindle checkpoint)",
                            mechanism: "Prevents microtubule polymerization → no functional spindle",
                            mitoticIndex: "Dramatically increased (20-40%)",
                            distribution: "Most cells in metaphase (~80-90% of dividing cells)",
                            appearance: {
                                Cmitosis: "Chromosomes scattered in cell (no metaphase plate)",
                                noSpindle: "No organized spindle structure",
                                hypercondensed: "Chromosomes remain condensed",
                                polyploidy: "Extended arrest can lead to chromosome re-replication"
                            },
                            checkpoint: "Spindle assembly checkpoint (M checkpoint) activated but cannot be satisfied"
                        },
                        hydroxyurea: {
                            effect: "Arrests cells in S phase (G1/S or intra-S checkpoint)",
                            mechanism: "Inhibits ribonucleotide reductase → blocks dNTP synthesis → halts DNA replication",
                            mitoticIndex: "Dramatically decreased (<1%)",
                            distribution: "Most cells in interphase (S phase specifically)",
                            appearance: {
                                enlarged: "Cells may be enlarged (stuck in S, continue growing)",
                                nucleus: "Nucleus may appear abnormal (partially replicated DNA)",
                                noMitotic: "Very few or no mitotic figures"
                            },
                            checkpoint: "S phase checkpoint and/or G2/M checkpoint (DNA replication incomplete)"
                        },
                        caffeine: {
                            effect: "Bypasses G2/M checkpoint (checkpoint override)",
                            mechanism: "Inhibits ATM/ATR kinases → cells enter mitosis despite DNA damage or incomplete replication",
                            mitoticIndex: "May increase slightly or show abnormal mitosis",
                            distribution: "More mitotic cells, but many abnormal",
                            appearance: {
                                abnormalMitosis: "Cells with damaged or incompletely replicated DNA in mitosis",
                                fragmented: "Chromosome fragments or bridges",
                                multiPolar: "Some cells with multipolar spindles"
                            },
                            warning: "Highly toxic to cells - overrides safety checkpoints"
                        }
                    },
                    expectedResults: {
                        control: {
                            mitoticIndex: "7.5%",
                            distribution: "Interphase 92.5%, Prophase 4%, Metaphase 1.5%, Anaphase 0.5%, Telophase 1.5%"
                        },
                        colchicine: {
                            mitoticIndex: "35% (massive accumulation in metaphase)",
                            distribution: "Interphase 65%, Metaphase 33% (arrested), others <2%",
                            note: "C-mitosis - scattered chromosomes, no spindle"
                        },
                        hydroxyurea: {
                            mitoticIndex: "0.5% (very few dividing cells)",
                            distribution: "Interphase 99.5%, Mitosis <0.5%",
                            note: "Cells arrested in S phase (look like interphase)"
                        }
                    },
                    dataTable: [
                        ["Treatment", "Total Cells", "Mitotic Index", "Interphase", "Prophase", "Metaphase", "Anaphase", "Telophase"],
                        ["Control", "200", "7.5%", "92.5%", "4.0%", "1.5%", "0.5%", "1.5%"],
                        ["Colchicine", "200", "35.0%", "65.0%", "1.0%", "33.0%", "0%", "1.0%"],
                        ["Hydroxyurea", "200", "0.5%", "99.5%", "0.5%", "0%", "0%", "0%"],
                        ["Caffeine", "200", "10.0%", "90.0%", "5.0%", "2.0%", "1.5%", "1.5%*"]
                    ],
                    analysis: {
                        colchicine: [
                            "Massive increase in metaphase cells confirms spindle checkpoint arrest",
                            "Cells detect unattached kinetochores, activate Mad2/BubR1, inhibit APC/C",
                            "Checkpoint cannot be satisfied (no spindle) → prolonged arrest",
                            "Eventually cells may die (apoptosis) or become polyploid (slip through checkpoint)",
                            "Used clinically: karyotyping (arrests at metaphase when chromosomes most condensed)"
                        ],
                        hydroxyurea: [
                            "Dramatic decrease in mitotic index confirms S phase arrest",
                            "ATR/ATM kinases detect stalled replication forks",
                            "Activate p53 → p21 → CDK inhibition → cycle arrest",
                            "Cells cannot proceed to G2 or M without completing DNA replication",
                            "Used clinically: synchronize cell populations, treat sickle cell disease"
                        ],
                        caffeine: [
                            "Checkpoint bypass leads to premature or inappropriate mitosis",
                            "Cells with incomplete DNA replication or damage enter mitosis",
                            "Results in abnormal mitosis, chromosome breakage, cell death",
                            "Demonstrates importance of checkpoints in maintaining genomic stability"
                        ],
                        checkpointImportance: "Without checkpoints, cells would divide with damaged DNA, incomplete replication, or misaligned chromosomes → aneuploidy, cancer"
                    },
                    connectionToHartwellNurse: {
                        mutantAnalogy: "Chemical inhibitors mimic genetic mutations studied by Hartwell and Nurse",
                        colchicine: "Mimics cdc mutants arrested at mitosis (spindle checkpoint mutants)",
                        hydroxyurea: "Mimics cdc mutants arrested in S phase",
                        molecularMechanism: {
                            cyclins: "Inhibitors affect cyclin-CDK activity indirectly",
                            checkpoints: "Demonstrate checkpoint proteins discovered by Hartwell (Mad2, BubR1, p53, etc.)",
                            conservation: "Same checkpoints operate in yeast and humans (universal mechanism)"
                        },
                        cancerConnection: "Many cancers have defective checkpoints (p53 mutations, Mad2 defects) → tolerate errors"
                    },
                    molecularExplanation: {
                        colchicineArrest: {
                            step1: "Colchicine binds tubulin dimers, prevents polymerization",
                            step2: "No functional spindle forms",
                            step3: "Kinetochores remain unattached",
                            step4: "Mad2/BubR1 produce 'wait anaphase' signal",
                            step5: "APC/C remains inhibited",
                            step6: "Securin not degraded → cohesin stays intact → sister chromatids attached",
                            step7: "Cell arrested at metaphase"
                        },
                        hydroxyureaArrest: {
                            step1: "Hydroxyurea inhibits ribonucleotide reductase",
                            step2: "dNTP pools depleted",
                            step3: "DNA polymerase stalls → replication forks stall",
                            step4: "ATR kinase recruited to stalled forks",
                            step5: "ATR activates Chk1 kinase",
                            step6: "Chk1 inhibits CDC25 phosphatase",
                            step7: "CDK1 remains inhibited (phosphorylated by Wee1)",
                            step8: "Cannot enter mitosis (MPF inactive)"
                        }
                    },
                    results: "Chemical inhibitors arrest cells at specific cell cycle stages, confirming the existence and function of cell cycle checkpoints. Colchicine arrests at metaphase (spindle checkpoint), hydroxyurea arrests in S phase (replication checkpoint).",
                    conclusions: [
                        "Cell cycle has multiple checkpoints ensuring fidelity of division",
                        "Spindle checkpoint (M checkpoint) prevents anaphase until all chromosomes attached",
                        "S phase checkpoints prevent mitosis with incomplete DNA replication",
                        "Chemical inhibitors can mimic genetic mutations affecting cell cycle",
                        "Checkpoints are critical for preventing aneuploidy and maintaining genomic stability",
                        "Loss of checkpoint control is a hallmark of cancer"
                    ],
                    realWorldApplications: [
                        "Cancer treatment: Many chemotherapy drugs target cell cycle (colchicine-like drugs, hydroxyurea)",
                        "Cell synchronization: Use inhibitors to synchronize cells for research",
                        "Karyotyping: Colchicine used clinically to arrest cells at metaphase",
                        "Understanding cancer: Many cancers have checkpoint defects",
                        "Drug development: Target cell cycle for anti-cancer therapies (CDK inhibitors)",
                        "Sickle cell disease: Hydroxyurea treatment increases fetal hemoglobin"
                    ],
                    extensions: [
                        "Test dose-response (vary inhibitor concentration)",
                        "Time course: Sample at different times after treatment",
                        "Reversibility: Remove inhibitor, observe recovery",
                        "Combination treatments: Colchicine + hydroxyurea",
                        "Test other inhibitors: Nocodazole (spindle), Aphidicolin (DNA pol)",
                        "Quantify apoptosis after prolonged arrest (TUNEL assay if available)"
                    ],
                    limitations: [
                        "Fixed cells - snapshots, not observing checkpoint dynamics",
                        "Chemical inhibitors may have off-target effects",
                        "Cannot directly observe molecular checkpoint proteins",
                        "Plant cells may respond differently than animal cells to some inhibitors"
                    ],
                    modernTechniques: {
                        flowCytometry: "Measure DNA content to precisely determine cell cycle stage",
                        liveCellImaging: "Fluorescent reporters show checkpoint activation in real time",
                        immunofluorescence: "Visualize checkpoint proteins (Mad2, p-Histone H3)",
                        westernBlotting: "Detect cyclin levels and CDK phosphorylation states"
                    }
                }
            },

            // ========================================
            // CHROMOSOME NONDISJUNCTION EXPERIMENT
            // ========================================

            calvin_bridges_nondisjunction: {
                name: "Calvin Bridges' Proof of Chromosome Theory - Nondisjunction in Drosophila",
                relatedTopics: ['meiosis', 'chromosome_structure', 'gametogenesis'],
                category: 'chromosome_genetics',
                historicalBackground: {
                    scientist: "Calvin Bridges",
                    year: "1913-1914",
                    mentor: "Thomas Hunt Morgan (Columbia University 'Fly Room')",
                    contribution: "First definitive proof that genes are physically located on chromosomes",
                    context: "Chromosome theory proposed but not universally accepted; needed direct proof linking genes to specific chromosomes",
                    discovery: {
                        observation: "Exceptional white-eyed female flies and red-eyed male flies in cross that shouldn't produce them",
                        explanation: "Nondisjunction of X chromosomes during meiosis",
                        proof: "Cytological examination showed abnormal chromosome number correlated perfectly with exceptional phenotype"
                    },
                    experiment: {
                        cross: "White-eyed female (XwXw) × Red-eyed male (XW Y)",
                        expected: "All daughters red-eyed (XW Xw), all sons white-eyed (Xw Y)",
                        observed: "Most as expected, BUT ~1/2000: exceptional white-eyed females (XwXwY) and exceptional red-eyed males (XW O)",
                        explanation: "X chromosomes failed to separate in female meiosis (nondisjunction)",
                        verification: "Microscopic examination confirmed: exceptional females had XXY, exceptional males had XO"
                    },
                    significance: "Provided unequivocal proof that genes are on chromosomes - correlation between genetic and cytological observations",
                    nobelContext: "Work contributed to Morgan's 1933 Nobel Prize",
                    quote: "The correspondence between the genetic and cytological facts is complete",
                    impact: "Settled chromosome theory debate; established Drosophila as premier genetic model organism"
                },
                labExperiment: {
                    title: "Modeling Meiotic Nondisjunction and Chromosomal Disorders",
                    hypothesis: "If chromosomes fail to separate properly during meiosis (nondisjunction), then gametes will have abnormal chromosome numbers, resulting in offspring with chromosomal disorders",
                    purpose: "Understand how errors in meiosis lead to aneuploidy and chromosomal disorders in offspring",
                    background: {
                        nondisjunction: "Failure of homologous chromosomes (meiosis I) or sister chromatids (meiosis II) to separate",
                        aneuploidy: "Abnormal number of chromosomes (not a multiple of haploid set)",
                        types: {
                            trisomy: "Three copies of a chromosome (2n+1)",
                            monosomy: "One copy of a chromosome (2n-1)",
                            nullisomy: "No copies of a chromosome (lethal in diploid organisms)"
                        },
                        humanExamples: {
                            downSyndrome: "Trisomy 21 (47 chromosomes: 2n+1)",
                            edwardsSyndrome: "Trisomy 18",
                            patauSyndrome: "Trisomy 13",
                            turnerSyndrome: "XO (45 chromosomes: monosomy X)",
                            klinefelterSyndrome: "XXY (47 chromosomes: trisomy X in male)"
                        },
                        maternalAgeEffect: "Risk increases dramatically after age 35 (cohesin degradation)"
                    },
                    variables: {
                        independent: "Stage of meiosis where nondisjunction occurs (I or II)",
                        dependent: "Chromosome number in resulting gametes and offspring",
                        controlled: ["Parent genotypes", "Normal vs nondisjunction event", "Fertilization combinations"]
                    },
                    materials: [
                        "Beads or poker chips (2 colors for homologous chromosomes)",
                        "String or pipe cleaners to represent chromosomes",
                        "Paper and markers for drawing diagrams",
                        "Dice (to simulate random nondisjunction events)",
                        "Worksheets for recording gamete genotypes",
                        "Large poster board for displaying meiotic stages",
                        "Labels for chromosomes (e.g., '21' for chromosome 21)"
                    ],
                    safetyPrecautions: [
                        "No specific hazards - modeling activity only"
                    ],
                    procedure: [
                        "PART 1: NORMAL MEIOSIS (CONTROL)",
                        "",
                        "Model normal meiosis:",
                        "Start with diploid cell (2n = 4 for simplicity; 2 homologous pairs)",
                        "Use 2 red beads (maternal chromosomes) and 2 blue beads (paternal chromosomes)",
                        "",
                        "Meiosis I:",
                        "Pair homologous chromosomes (red-blue pairs)",
                        "Separate homologous pairs to opposite poles",
                        "Result: Two cells, each with 2 chromosomes (one red, one blue of different types)",
                        "",
                        "Meiosis II:",
                        "Separate sister chromatids",
                        "Result: Four haploid gametes (n = 2), each with one chromosome from each pair",
                        "",
                        "Gamete types: All have normal chromosome number (n = 2)",
                        "",
                        "PART 2: NONDISJUNCTION IN MEIOSIS I",
                        "",
                        "Model nondisjunction during meiosis I:",
                        "Start with diploid cell (2n = 4)",
                        "During meiosis I, homologous chromosomes of one pair FAIL to separate",
                        "Example: Both chromosomes 21 (one red, one blue) go to same pole",
                        "",
                        "Result after meiosis I:",
                        "Cell 1: Has both chromosomes 21 (n+1 = 3 chromosomes)",
                        "Cell 2: Has no chromosome 21 (n-1 = 1 chromosome)",
                        "",
                        "Complete meiosis II (sister chromatids separate normally):",
                        "",
                        "From Cell 1 (n+1):",
                        "Two gametes with EXTRA chromosome 21 (n+1)",
                        "",
                        "From Cell 2 (n-1):",
                        "Two gametes MISSING chromosome 21 (n-1)",
                        "",
                        "Gamete types produced:",
                        "50% with n+1 chromosomes (trisomy if fertilized)",
                        "50% with n-1 chromosomes (monosomy if fertilized)",
                        "",
                        "PART 3: NONDISJUNCTION IN MEIOSIS II",
                        "",
                        "Model nondisjunction during meiosis II:",
                        "Complete meiosis I normally (homologs separate)",
                        "Result: Two cells with n = 2 chromosomes each",
                        "",
                        "During meiosis II, sister chromatids of one chromosome FAIL to separate in ONE cell:",
                        "",
                        "Cell 1 (nondisjunction in meiosis II):",
                        "Sister chromatids of chromosome 21 do NOT separate",
                        "Both go to one pole",
                        "Result: One gamete with n+1, one gamete with n-1",
                        "",
                        "Cell 2 (normal meiosis II):",
                        "Sister chromatids separate normally",
                        "Result: Two normal gametes with n chromosomes",
                        "",
                        "Gamete types produced:",
                        "25% with n+1 chromosomes",
                        "25% with n-1 chromosomes",
                        "50% with normal n chromosomes",
                        "",
                        "PART 4: FERTILIZATION OUTCOMES",
                        "",
                        "Simulate fertilization with normal gamete (n):",
                        "",
                        "If n+1 gamete fertilized by normal n gamete:",
                        "Offspring: 2n+1 (trisomy, e.g., Down syndrome if chromosome 21)",
                        "",
                        "If n-1 gamete fertilized by normal n gamete:",
                        "Offspring: 2n-1 (monosomy, usually lethal except Turner syndrome XO)",
                        "",
                        "Create Punnett square-style diagram showing all possible fertilization outcomes",
                        "",
                        "PART 5: SIMULATING MATERNAL AGE EFFECT",
                        "",
                        "Simulate multiple meiotic events:",
                        "Young mother (age 20-30): Roll dice; nondisjunction on roll of 1 (1/6 = ~16%, but really ~0.1%)",
                        "Older mother (age 40+): Roll dice; nondisjunction on roll of 1-3 (3/6 = 50%, exaggerated for demonstration)",
                        "",
                        "Perform 20 simulated meioses for each age group",
                        "Count frequency of abnormal gametes",
                        "Compare rates"
                    ],
                    observations: {
                        normalMeiosis: {
                            gametes: "All gametes have n chromosomes",
                            offspring: "All offspring have 2n chromosomes (normal)",
                            frequency: "100% normal if no errors"
                        },
                        meiosisI_nondisjunction: {
                            gametes: "50% n+1, 50% n-1 (all gametes abnormal from that meiosis)",
                            offspring: {
                                trisomy: "n+1 gamete + n gamete = 2n+1 (e.g., Down syndrome)",
                                monosomy: "n-1 gamete + n gamete = 2n-1 (usually lethal)"
                            },
                            frequency: "100% of gametes from that meiosis are abnormal"
                        },
                        meiosisII_nondisjunction: {
                            gametes: "25% n+1, 25% n-1, 50% normal n",
                            offspring: {
                                normal: "50% chance (n gamete + n gamete = 2n)",
                                trisomy: "25% chance (n+1 + n = 2n+1)",
                                monosomy: "25% chance (n-1 + n = 2n-1)"
                            },
                            frequency: "Only 50% of gametes from that meiosis are abnormal"
                        },
                        comparison: "Meiosis I nondisjunction produces 100% abnormal gametes; Meiosis II produces 50% abnormal"
                    },
                    expectedResults: {
                        normalMeiosis: {
                            gametes: "n, n, n, n (all normal)",
                            zygotes: "2n (all normal)"
                        },
                        meiosisI_nondisjunction: {
                            gametes: "n+1, n+1, n-1, n-1",
                            zygotes: "2n+1 (trisomy) or 2n-1 (monosomy)"
                        },
                        meiosisII_nondisjunction: {
                            gametes: "n, n, n+1, n-1",
                            zygotes: "50% 2n (normal), 25% 2n+1, 25% 2n-1"
                        }
                    },
                    dataTable: [
                        ["Nondisjunction Type", "Gamete 1", "Gamete 2", "Gamete 3", "Gamete 4", "% Abnormal Gametes"],
                        ["None (Normal)", "n", "n", "n", "n", "0%"],
                        ["Meiosis I", "n+1", "n+1", "n-1", "n-1", "100%"],
                        ["Meiosis II", "n", "n", "n+1", "n-1", "50%"],
                        ["", "", "", "", "", ""],
                        ["Fertilization Outcome (nondisjunction gamete + normal gamete)", "", "", "", "", ""],
                        ["Gamete Type", "Fertilized by Normal (n)", "Resulting Zygote", "Chromosome Number", "Example Syndrome"],
                        ["n+1", "n", "2n+1", "47 (in humans)", "Down syndrome (trisomy 21)"],
                        ["n-1", "n", "2n-1", "45 (in humans)", "Turner syndrome (XO)"]
                    ],
                    analysis: {
                        interpretation: [
                            "Nondisjunction produces gametes with abnormal chromosome numbers",
                            "Meiosis I errors affect all four gametes (100% abnormal)",
                            "Meiosis II errors affect only two gametes (50% abnormal)",
                            "Fertilization of abnormal gamete → aneuploidy in offspring",
                            "Most aneuploidies are lethal (miscarriage); only some trisomies viable"
                        ],
                        humanConsequences: {
                            trisomy21: "Down syndrome - intellectual disability, heart defects, characteristic features",
                            trisomy18: "Edwards syndrome - severe, usually fatal in infancy",
                            trisomy13: "Patau syndrome - severe, usually fatal",
                            monosomyX: "Turner syndrome (XO) - short stature, infertility, webbed neck",
                            trisomyX: "Klinefelter syndrome (XXY) - tall stature, small testes, infertility",
                            autosomes: "Most autosomal monosomies are lethal (not viable)"
                        },
                        maternalAge: {
                            youngMother: "Low risk (~1/1000 for Down syndrome at age 20)",
                            olderMother: "High risk (~1/30 for Down syndrome at age 45)",
                            mechanism: "Oocytes arrested in prophase I since before birth; cohesin proteins degrade over decades",
                            spermEffect: "Paternal age effect less pronounced (fresh meiosis each cycle)"
                        }
                    },
                    connectionToBridges: {
                        originalObservation: "Exceptional flies had abnormal chromosome numbers matching abnormal phenotypes",
                        proof: "Genetic prediction (exceptional white female) matched cytological observation (XXY)",
                        impact: "Demonstrated genes physically on chromosomes - not abstract units",
                        modernRelevance: "Same principle applies to human chromosomal disorders - karyotyping confirms aneuploidy"
                    },
                    molecularExplanation: {
                        normalSeparation: {
                            meiosisI: "Cohesin along arms cleaved, centromeric cohesin protected → homologs separate",
                            meiosisII: "Centromeric cohesin cleaved → sister chromatids separate"
                        },
                        nondisjunction: {
                            meiosisI: "Chiasmata fail to form OR cohesin defective → homologs don't separate properly",
                            meiosisII: "Centromeric cohesin cleaved prematurely or delayed → sisters missegregate",
                            spindle: "Attachment errors (both kinetochores to same pole)"
                        },
                        ageEffect: "Cohesin subunits (especially REC8) degrade over time in arrested oocytes"
                    },
                    results: "Modeling demonstrates that nondisjunction during meiosis produces gametes with abnormal chromosome numbers. Meiosis I nondisjunction affects all gametes; meiosis II affects half. Fertilization of abnormal gametes results in aneuploid offspring.",
                    conclusions: [
                        "Nondisjunction is the failure of chromosomes to separate properly during meiosis",
                        "Results in gametes with too many or too few chromosomes (aneuploidy)",
                        "Meiosis I nondisjunction produces all abnormal gametes from that cell",
                        "Meiosis II nondisjunction produces half normal, half abnormal gametes",
                        "Aneuploid offspring have chromosomal disorders (Down syndrome, Turner syndrome, etc.)",
                        "Maternal age is major risk factor due to cohesin degradation in arrested oocytes",
                        "Bridges' observation of nondisjunction proved chromosome theory of inheritance"
                    ],
                    realWorldApplications: [
                        "Prenatal genetic screening (maternal serum markers, NIPT)",
                        "Prenatal diagnosis (amniocentesis, CVS, karyotyping)",
                        "Genetic counseling for older mothers (risk assessment)",
                        "Understanding causes of miscarriage (~50% due to aneuploidy)",
                        "Preimplantation genetic testing (PGT) in IVF",
                        "Research on cohesin and chromosome segregation"
                    ],
                    extensions: [
                        "Model sex chromosome nondisjunction (XXY, XO, XXX, XYY)",
                        "Calculate risk of Down syndrome at different maternal ages",
                        "Research why most aneuploidies are lethal (gene dosage imbalance)",
                        "Investigate why trisomy 21, 18, 13 are viable but others not",
                        "Examine mosaicism (nondisjunction in early embryo mitosis)",
                        "Model double nondisjunction (both meiosis I and II)"
                    ],
                    limitations: [
                        "Physical model simplifies complex molecular mechanisms",
                        "Does not show why cohesin degrades with age",
                        "Cannot model selection against aneuploid embryos (most miscarry)",
                        "Simplified probability (real rates much lower than modeled)"
                    ],
                    modernTechniques: {
                        karyotyping: "Still gold standard - visualize all chromosomes (Bridges' approach updated)",
                        FISH: "Fluorescence in situ hybridization - probe for specific chromosomes",
                        arrayGGH: "Microarray - detect small deletions/duplications",
                        NIPT: "Non-invasive prenatal testing - fetal DNA in maternal blood",
                        PGT_A: "Preimplantation genetic testing for aneuploidy - test IVF embryos"
                    }
                }
            },

            // ========================================
            // CYTOKINESIS EXPERIMENT
            // ========================================

            rappaport_contractile_ring: {
                name: "Rappaport's Experiments on Cytokinesis - Discovering the Cleavage Furrow Signal",
                relatedTopics: ['cytokinesis', 'mitosis', 'cell_cycle'],
                category: 'cell_division_mechanics',
                historicalBackground: {
                    scientist: "Rappaport (and earlier: Hörstadius, Dan)",
                    year: "1960s-1980s",
                    contribution: "Identified signals that position the cleavage furrow during animal cell cytokinesis",
                    context: "How does cell know WHERE to divide? What signals position the contractile ring?",
                    experiments: {
                        seaUrchinEggs: "Used large, transparent sea urchin eggs to manipulate and observe division",
                        manipulation: "Physically displaced spindle, created artificial asters with centrosomes",
                        observation: "Furrow always forms between asters (spindle poles), regardless of spindle position"
                    },
                    discovery: {
                        astralStimulation: "Astral microtubules from both poles send signals to cell cortex",
                        positioning: "Furrow forms at cell equator, equidistant from both asters",
                        centralSpindle: "Later work showed central spindle (midzone microtubules) also important",
                        RhoAzone: "Signals activate RhoA GTPase at equator → contractile ring assembly"
                    },
                    significance: "Established that spindle position determines cleavage plane; laid foundation for understanding cytokinesis mechanics",
                    quote: "The position of the cleavage furrow is determined by the position of the mitotic apparatus",
                    modernView: "Both astral microtubules AND central spindle contribute signals; RhoA is key effector"
                },
                labExperiment: {
                    title: "Observing Cytokinesis in Animal and Plant Cells: Comparative Study",
                    hypothesis: "Animal and plant cells use different mechanisms for cytokinesis due to differences in cell structure (cell wall vs no cell wall)",
                    purpose: "Compare cytokinesis mechanisms in animal cells (cleavage furrow) and plant cells (cell plate formation)",
                    background: {
                        animalCytokinesis: {
                            mechanism: "Cleavage furrow - contractile ring of actin and myosin pinches cell",
                            positioning: "Determined by astral microtubules and central spindle",
                            direction: "Centripetal (inward)",
                            proteins: "Actin, myosin II, anillin, RhoA"
                        },
                        plantCytokinesis: {
                            mechanism: "Cell plate formation - vesicles fuse to build new cell wall",
                            positioning: "At former metaphase plate, guided by phragmoplast",
                            direction: "Centrifugal (outward from center)",
                            proteins: "Phragmoplast microtubules, kinesins, dynamin-related proteins",
                            reason: "Rigid cell wall prevents cleavage"
                        }
                    },
                    variables: {
                        independent: "Cell type (animal vs plant)",
                        dependent: "Mechanism of cytoplasmic division observed",
                        controlled: ["Staining method", "Microscope settings", "Cell stage observed"]
                    },
                    materials: [
                        "Prepared slides: Animal cells in division (whitefish blastula)",
                        "Prepared slides: Plant cells in division (onion root tip)",
                        "Compound light microscope",
                        "Alternatively: Live cells and stains:",
                        "  - Cultured animal cells (HeLa, CHO)",
                        "  - Fresh onion root tips",
                        "  - Phalloidin-fluorophore (to stain actin)",
                        "  - Tubulin antibody-fluorophore (to stain microtubules)",
                        "  - Fluorescence microscope",
                        "Camera or smartphone adapter for microscope",
                        "Drawing materials for sketching observations"
                    ],
                    safetyPrecautions: [
                        "Handle microscope slides carefully",
                        "If using live cells and fluorescent stains: wear gloves, follow proper disposal"
                    ],
                    procedure: [
                        "PART 1: OBSERVATION OF ANIMAL CELL CYTOKINESIS",
                        "",
                        "Examine whitefish blastula prepared slide:",
                        "These embryonic cells divide rapidly, many in division",
                        "",
                        "Low power (10x): Locate dividing cells",
                        "High power (40x or 100x oil): Observe late anaphase/telophase cells",
                        "",
                        "Look for:",
                        "Cleavage furrow: Indentation forming at cell equator",
                        "Contractile ring region: Darkly stained band where furrow forms",
                        "Spindle remnants: Microtubules between separating chromosome groups",
                        "Midbody: Dense region of overlapping microtubules at furrow",
                        "",
                        "Observe progression:",
                        "Early telophase: Shallow furrow beginning",
                        "Mid telophase: Deep furrow, cell dumbbell-shaped",
                        "Late telophase: Narrow cytoplasmic bridge remains (midbody)",
                        "Abscission: Complete separation (may not see - occurs later)",
                        "",
                        "Sketch and label:",
                        "Cleavage furrow",
                        "Contractile ring position",
                        "Spindle/midbody",
                        "Daughter nuclei",
                        "",
                        "PART 2: OBSERVATION OF PLANT CELL CYTOKINESIS",
                        "",
                        "Examine onion root tip slide:",
                        "Same slide from mitosis observation",
                        "",
                        "Locate cells in late telophase (two nuclei forming)",
                        "",
                        "Look for:",
                        "Cell plate: Dark line forming between daughter nuclei (perpendicular to spindle axis)",
                        "Phragmoplast: May see as lighter region around forming cell plate (microtubules)",
                        "Cell plate formation: Starts at center, grows outward to cell wall",
                        "",
                        "Observe stages:",
                        "Early telophase: Cell plate just beginning (small line in center)",
                        "Mid telophase: Cell plate extending outward",
                        "Late telophase: Cell plate reaches parent cell wall",
                        "Complete: New cell wall visible, two distinct daughter cells",
                        "",
                        "Sketch and label:",
                        "Cell plate",
                        "Direction of growth (outward arrows)",
                        "Phragmoplast region",
                        "Daughter nuclei",
                        "Parent cell wall",
                        "",
                        ...
                        "Direction | Inward (centripetal) | Outward (centrifugal)",
                        "Cytoskeleton | Actin-myosin ring | Phragmoplast (microtubules)",
                        "Membrane addition | Limited | Extensive (vesicle fusion)",
                        "Cell wall | Absent | Must build new wall",
                        "",
                        "PART 4: ADVANCED (if fluorescence microscope available)",
                        "",
                        "Fluorescence imaging of live cells:",
                        "",
                        "Animal cells:",
                        "Stain with phalloidin-fluorophore (labels F-actin)",
                        "Observe contractile ring as bright band at furrow",
                        "Time-lapse: Watch ring contract over 10-30 minutes",
                        "",
                        "Plant cells:",
                        "Stain microtubules (anti-tubulin antibody)",
                        "Observe phragmoplast as array of microtubules",
                        "Watch cell plate expand outward"
                    ],
                    observations: {
                        animalCells: {
                            appearance: "Cleavage furrow visible as indentation at cell equator",
                            contractileRing: "Darkly stained band at furrow (concentrated actin-myosin)",
                            progression: "Furrow deepens progressively, 'pinching' cell in two",
                            midbody: "Final cytoplasmic bridge with dense microtubule bundle",
                            timing: "Furrow ingression ~10-30 minutes; abscission ~1 hour after",
                            orientation: "Furrow perpendicular to spindle axis"
                        },
                        plantCells: {
                            appearance: "Cell plate visible as dark line between nuclei",
                            phragmoplast: "Array of microtubules surrounding cell plate",
                            progression: "Cell plate grows outward from center to periphery",
                            completion: "Cell plate fuses with parent cell wall",
                            timing: "Cell plate formation ~30-60 minutes",
                            orientation: "Cell plate at former metaphase plate position",
                            cellWall: "New cell wall deposited in cell plate region"
                        },
                        comparison: {
                            animalInward: "Cleavage furrow moves inward (centripetal)",
                            plantOutward: "Cell plate grows outward (centrifugal)",
                            animalActin: "Depends on actin-myosin contractility",
                            plantMicrotubules: "Depends on microtubules (phragmoplast) and vesicle fusion",
                            result: "Both produce two daughter cells with separate cytoplasm"
                        }
                    },
                    expectedResults: {
                        animalCytokinesis: {
                            mechanism: "Contractile ring constricts like purse-string",
                            structure: "Cleavage furrow deepens until midbody forms",
                            completion: "Abscission severs final membrane connection"
                        },
                        plantCytokinesis: {
                            mechanism: "Vesicles fuse at center, forming cell plate",
                            structure: "Cell plate expands outward to parent wall",
                            completion: "Cell wall deposited, two cells with walls"
                        }
                    },
                    dataTable: [
                        ["Feature", "Animal Cytokinesis (Whitefish)", "Plant Cytokinesis (Onion)"],
                        ["Mechanism", "Cleavage furrow", "Cell plate formation"],
                        ["Direction of division", "Centripetal (inward)", "Centrifugal (outward)"],
                        ["Primary cytoskeleton", "Actin-myosin contractile ring", "Microtubule phragmoplast"],
                        ["Initiates at", "Cell cortex (equator)", "Center of cell (metaphase plate)"],
                        ["Vesicle fusion", "Minimal", "Extensive"],
                        ["Cell wall synthesis", "No cell wall", "New cell wall deposited"],
                        ["Membrane source", "Existing plasma membrane", "Golgi vesicles"],
                        ["Timing (approx)", "10-30 min (ingression)", "30-60 min"],
                        ["Final structure", "Midbody (residual microtubules)", "Middle lamella (pectin-rich layer)"]
                    ],
                    analysis: {
                        interpretation: [
                            "Animal cells use actin-myosin contractility to pinch cell in two",
                            "Plant cells cannot use contractile ring due to rigid cell wall",
                            "Plant cells build new cell wall from inside out (cell plate)",
                            "Both mechanisms ensure each daughter cell receives complete cytoplasm",
                            "Spindle position determines division plane in both cell types",
                            "Different solutions to same problem (separate two daughter nuclei)"
                        ],
                        evolutionaryPerspective: "Plant cells evolved cell plate mechanism after divergence from animal lineage and acquisition of cell wall"
                    },
                    connectionToRappaport: {
                        positioning: "Rappaport showed spindle position determines where furrow forms in animal cells",
                        mechanism: "Astral microtubules signal to RhoA at cell equator",
                        plantEquivalent: "Phragmoplast microtubules position cell plate at former metaphase plate",
                        universal: "Both use spindle-derived signals, but different mechanisms"
                    },
                    molecularExplanation: {
                        animalCells: {
                            step1: "Astral and central spindle microtubules recruit RhoGEF (ECT2) to equator",
                            step2: "RhoGEF activates RhoA GTPase at cell cortex",
                            step3: "RhoA activates formins (actin nucleation) and ROCK (myosin activation)",
                            step4: "Actin filaments and myosin II assemble into contractile ring",
                            step5: "Myosin walks on actin, ring contracts",
                            step6: "Membrane pulled inward, furrow deepens",
                            step7: "ESCRT-III complex mediates final abscission"
                        },
                        plantCells: {
                            step1: "Phragmoplast microtubules derive from spindle midzone",
                            step2: "Kinesin motors transport Golgi vesicles to phragmoplast",
                            step3: "Vesicles accumulate at cell center (former metaphase plate)",
                            step4: "Dynamin-related proteins mediate vesicle fusion → tubular network",
                            step5: "Network matures into fenestrated sheet → continuous membrane",
                            step6: "Cell wall precursors (pectin, cellulose) deposited between membranes",
                            step7: "Cell plate expands outward, guided by phragmoplast",
                            step8: "Cell plate fuses with parent plasma membrane and wall"
                        }
                    },
                    results: "Animal cells divide via cleavage furrow (contractile ring mechanism), while plant cells form a cell plate (vesicle fusion mechanism). Both ensure proper cytoplasmic separation and are positioned by the mitotic spindle.",
                    conclusions: [
                        "Cytokinesis mechanisms differ between animal and plant cells",
                        "Animal cells: Cleavage furrow via actin-myosin contractile ring (inward)",
                        "Plant cells: Cell plate formation via vesicle fusion (outward)",
                        "Rigid plant cell wall necessitates different mechanism",
                        "Both mechanisms position division plane based on spindle position",
                        "Rappaport's work showed spindle signals determine cleavage position",
                        "Cytokinesis completes cell division initiated by mitosis/meiosis"
                    ],
                    realWorldApplications: [
                        "Understanding cancer: Cytokinesis failure → polyploidy → genomic instability",
                        "Drug development: Target cytokinesis in cancer cells",
                        "Developmental biology: Asymmetric divisions in stem cells",
                        "Plant biology: Understand cell plate defects (affect growth, development)",
                        "Evolution: Compare cytokinesis across kingdoms",
                        "Cell biology: Study cytoskeletal dynamics and membrane trafficking"
                    ],
                    extensions: [
                        "Time-lapse microscopy of live cells undergoing cytokinesis",
                        "Immunofluorescence: Label actin (animal) or tubulin (plant) during cytokinesis",
                        "Drug effects: Cytochalasin D blocks actin (stops animal cytokinesis)",
                        "Compare cytokinesis in other organisms (bacteria, fungi)",
                        "Investigate asymmetric cytokinesis (oocyte meiosis, stem cells)",
                        "Model cytokinesis failure → binucleate cells (like some cancer cells)"
                    ],
                    limitations: [
                        "Fixed cells - snapshots, not observing dynamics",
                        "Cannot see molecular players (RhoA, myosin, kinesins) without specialized techniques",
                        "Plant cell plate early stages difficult to see with standard light microscopy"
                    ],
                    modernTechniques: {
                        liveCellImaging: "Fluorescent protein-tagged actin, myosin, tubulin - watch dynamics",
                        FRAP: "Fluorescence recovery after photobleaching - measure turnover rates",
                        optogenetics: "Light-activated RhoA to control furrow position",
                        electronMicroscopy: "Ultrastructure of cell plate and midbody",
                        superResolution: "Nanoscale organization of contractile ring"
                    }
                }
            }
        };
                ...
                spermStructure: {
                    ...
                    tail: {
                        ...
                        structure: {
                            ...
                            outer dense fibers: "9 fibers surrounding axoneme (structural support)",
                            fibrous sheath: "In principal piece, glycolytic enzymes"
                        },
                        regions: {
                            connecting piece: "Joins midpiece to principal piece",
                            principal piece: "Main length (~40-45 μm)",
                            end piece: "Terminal ~5 μm, only axoneme"
                        },
