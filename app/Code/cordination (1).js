                        ...
                        motor: {
                            ...
                            divisions: {
                                somatic: {
                                    ...
                                    control: "Voluntary control of skeletalmuscles",
            ...
            neuron_structure: {
                ...
                structure: {
                    ...
                    dendrites: {
                        ...
                        features: {
                            dendriticspines: "Small protrusions that form synaptic contacts",
        ...
        this.coordinationExperiments = {
            ...
            hodgkin_huxley_action_potential: {
                ...
                historicalBackground: {
                    ...
                    quote: "The agreement between the theoretical and experimental curves is remarkably good"
                },
                labExperiment: {
            ...
            banting_best_insulin: {
                ...
                historicalBackground: {
                    ...
                    quote: "I am almost afraid to go on for fear of what I may find"
                },
                labExperiment: {
...
handleBrainStructure(problem) {
    const content = {
            ...
            thalamus: {
                ...
                functions: {
                    ...
                    motorRelay: {
                        ...
                        ventralLateral: "Cerebellum/basal ganglia → motor cortex"
                    },
                    consciousness: {
                    ...
                    cognition: {
                        medialDorsal: "Prefrontal cortex connections - working memory, attention",
            ...
            hypothalamus: {
                ...
                functions: {
                    ...
                    endocrineControl: {
                        ...
                        releasingHormones: "TRH, CRH, GnRH, GHRH, dopamine, somatostatin",
                    ...
                    homeostasis: {
                        ...
                        hungerSatiety: "Feeding behavior (arcuate, lateral, ventromedial nuclei)",
                        sleepWake: "Circadian rhythms (suprachiasmatic nucleus - SCN)",
        ...
        brainstem: {
            ...
            pons: {
                ...
                functions: {
                    ...
                    pontineNuclei: "Receive cortical input, project to cerebellum (cortico-ponto-cerebellar pathway)",
        ...
        cerebellum: {
            ...
            connections: {
                input: {
                    mossyFibers: "From spinal cord (proprioception), pons (motor commands)",
                    climbingFibers: "From inferior olive (error signals)"
                },
                output: {
                    Purkinje: "Only output - inhibitory (GABA) → deep cerebellar nuclei",
                    deepNuclei: "Dentate, interposed, fastigial → thalamus, brainstem"
                },
                peduncles: {
...
handleAutonomicNervousSystem(problem) {
    const content = {
        ...
        sympathetic: {
            ...
            effects: {
                ...
                metabolic: {
                    ...
                    skeletalMuscle: "Glycogenolysis → glucose for muscle"
                },
        ...
        autonomicTone: {
            ...
            examples: {
                vagalTone: "Parasympathetic (vagus) continuously slows heart (~70 bpm) - if blocked with atropine, rate increases to ~100 bpm (intrinsic SA node rate)",
                vascularTone: "Sympathetic maintains baseline vasoconstriction - can increase (more constriction) or decrease (vasodilation)",
                bronchialTone: "Parasympathetic maintains baseline bronchoconstriction"
            },
