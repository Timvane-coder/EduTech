...
function generateRelatedExponentialEquations() {
    const relatedProblems = [];

    // Problem 1: Simple Exponential Equation
    relatedProblems.push({
        difficulty: 'easier',
        scenario: 'Simple Exponential Equation',
        problem: 'Solve for x: 2^x = 8',
        parameters: { a: 2, b: 8 },
        type: 'simple_exponential',
        context: { difficulty: 'beginner', topic: 'Simple Exponential Equations' },
        subparts: [
            'Given: 2^x = 8',
            'Recognize: 8 = 2^3',
            'Therefore: 2^x = 2^3',
            'When bases are equal, exponents are equal',
            'x = 3',
            'Alternative: Take log of both sides',
            'log(2^x) = log(8)',
            'x·log(2) = log(8)',
            'x = log(8)/log(2) = 3',
            'Check: 2^3 = 8 ✓'
        ],
        helper: 'Try to express both sides with the same base',
        solution: 'x = 3',
        realWorldContext: 'Exponential growth with doubling patterns'
    });

    // Problem 2: Exponential with Logarithms
    relatedProblems.push({
        difficulty: 'similar',
        scenario: 'Exponential Equation with Logarithms',
        problem: 'Solve for x: 5^x = 125',
        parameters: { a: 5, b: 125 },
        type: 'simple_exponential',
        context: { difficulty: 'beginner', topic: 'Exponential Equations' },
        subparts: [
            'Given: 5^x = 125',
            'Recognize: 125 = 5^3',
            'Therefore: 5^x = 5^3',
            ...
            'Take ln of both sides: ln(5^x) = ln(125)',
            'x·ln(5) = ln(125)',
            'x = ln(125)/ln(5)',
            'x = 3',
            'Check: 5^3 = 125 ✓'
        ],
        helper: 'Use logarithms when bases cannot be matched',
        solution: 'x = 3',
        realWorldContext: 'Population growth and compound interest'
    });

    // Problem 3: Exponential with Coefficient
    relatedProblems.push({
        difficulty: 'similar',
        scenario: 'Exponential with Coefficient',
        problem: 'Solve for x: 3·2^x = 24',
        parameters: { coefficient: 3, a: 2, b: 24 },
        type: 'simple_exponential',
        context: { difficulty: 'intermediate', topic: 'Exponential Equations' },
        subparts: [
            'Given: 3·2^x = 24',
            'Step 1: Isolate exponential by dividing by 3',
            '2^x = 24/3',
            '2^x = 8',
            'Step 2: Recognize 8 = 2^3',
            '2^x = 2^3',
            'x = 3',
            'Alternative: Take logarithm',
            'ln(2^x) = ln(8)',
            'x·ln(2) = ln(8)',
            'x = ln(8)/ln(2) = 3',
            'Check: 3·2^3 = 3·8 = 24 ✓'
        ],
        helper: 'First isolate the exponential expression',
        solution: 'x = 3',
        realWorldContext: 'Scaled exponential growth models'
    });

    // Problem 4: Exponential Inequality
    relatedProblems.push({
        difficulty: 'harder',
        scenario: 'Exponential Inequality',
        problem: 'Solve: 2^x > 16',
        parameters: { a: 2, b: 16, operator: '>' },
        type: 'exponential_inequality',
        context: { difficulty: 'intermediate', topic: 'Exponential Inequalities' },
        subparts: [
            'Given: 2^x > 16',
            'Recognize: 16 = 2^4',
            'So: 2^x > 2^4',
            'Since base 2 > 1 (growth base):',
        ...
        helper: 'Growth bases (a>1) preserve inequality direction',
        solution: 'x > 4',
        realWorldContext: 'Finding threshold conditions'
    });
    ...
    relatedProblems.push({
        ...
        problem: 'Solve: (1/2)^x = 1/8',
        parameters: { a: 0.5, b: 0.125 },
        type: 'exponential_decay',
        context: { difficulty: 'intermediate', topic: 'Exponential Decay' },
        subparts: [
            'Given: (1/2)^x = 1/8',
            'Recognize: 1/8 = (1/2)^3',
            '(1/2)^x = (1/2)^3',
            'x = 3',
            'Alternative: Rewrite with negative exponents',
            '2^(-x) = 2^(-3)',
            '-x = -3',
            'x = 3',
            'Check: (1/2)^3 = 1/8 ✓',
            'This represents decay over 3 time periods'
        ],
        helper: 'Decay bases are between 0 and 1',
        solution: 'x = 3',
        realWorldContext: 'Radioactive decay and half-life problems'
    });
    ...
    /**relatedProblems.push({
        ...
        problem: 'Find time for $1000 to grow to $2000 at 5% annual interest compounded annually',
        parameters: { principal: 1000, finalAmount: 2000, rate: 0.05, compoundingFrequency: 1 },
        type: 'compound_interest',
        context: { difficulty: 'intermediate', topic: 'Compound Interest' },
        subparts: [
            'Given: P = $1000, A = $2000, r = 0.05, n = 1',
            'Formula: A = P(1 + r/n)^(nt)',
            'Substitute: 2000 = 1000(1 + 0.05/1)^(1·t)',
            'Simplify: 2 = (1.05)^t',
            'Take natural log: ln(2) = ln((1.05)^t)',
            'ln(2) = t·ln(1.05)',
            't = ln(2)/ln(1.05)',
            't = 0.6931/0.0488',
            't ≈ 14.21 years',
            'Answer: Approximately 14.21 years to double'
        ],
        helper: 'Use A = P(1+r/n)^(nt) for compound interest',
        solution: 't ≈ 14.21 years',
        realWorldContext: 'Investment doubling time calculations'
    });
    */

    // Problem 7: Half-Life Problem
    relatedProblems.push({
        difficulty: 'harder',
        scenario: 'Half-Life Decay',
        problem: 'Carbon-14 has half-life of 5730 years. How much of 100g remains after 11460 years?',
        parameters: { initialAmount: 100, halfLife: 5730, time: 11460 },
        type: 'half_life',
        context: { difficulty: 'intermediate', topic: 'Half-Life and Decay' },
        subparts: [
            'Given: A₀ = 100g, t₁/₂ = 5730 years, t = 11460 years',
            'Number of half-lives: n = 11460/5730 = 2',
            'Formula: A = A₀·(1/2)^n',
            'A = 100·(1/2)^2',
            'A = 100·(1/4)',
            'A = 25g',
            'Alternative: Use continuous decay formula',
            'k = ln(2)/t₁/₂ = 0.6931/5730 = 0.000121',
            'A = 100·e^(-0.000121·11460)',
            'A = 100·e^(-1.386)',
            'A ≈ 25g',
            'Answer: 25 grams remain after 2 half-lives'
        ],
        helper: 'After n half-lives, amount = initial × (1/2)^n',
        solution: '25 grams',
        realWorldContext: 'Radioactive dating and nuclear decay'
    });

    // Problem 8: Exponential Growth Model
    relatedProblems.push({
        difficulty: 'harder',
        scenario: 'Exponential Growth Model',
        problem: 'Population grows from 1000 to 5000 in 10 years. Find growth rate.',
        parameters: { initialAmount: 1000, finalAmount: 5000, time: 10 },
        type: 'exponential_growth',
        context: { difficulty: 'intermediate', topic: 'Exponential Growth Models' },
        subparts: [
            'Given: P₀ = 1000, P = 5000, t = 10 years',
            'Model: P = P₀·e^(kt)',
            'Substitute: 5000 = 1000·e^(10k)',
            'Divide by 1000: 5 = e^(10k)',
            'Take natural log: ln(5) = ln(e^(10k))',
            'ln(5) = 10k',
            'k = ln(5)/10',
            'k = 1.6094/10',
            'k ≈ 0.1609',
            'Growth rate: 16.09% per year',
            'Doubling time: ln(2)/k ≈ 4.31 years'
        ],
        helper: 'Use P = P₀·e^(kt) for continuous growth',
        solution: 'Growth rate ≈ 16.09% per year',
        realWorldContext: 'Population dynamics and bacterial growth'
    });

    // Problem 9: Logarithmic Equation
    relatedProblems.push({
        difficulty: 'similar',
        scenario: 'Logarithmic Equation',
        problem: 'Solve: log₂(x) = 5',
        parameters: { base: 2, result: 5 },
        type: 'logarithmic_equation',
        context: { difficulty: 'intermediate', topic: 'Logarithmic Equations' },
        subparts: [
            'Given: log₂(x) = 5',
            'Definition: log₂(x) = 5 means 2^5 = x',
            'Convert to exponential form:',
            'x = 2^5',
            'x = 32',
            'Check: log₂(32) = log₂(2^5) = 5 ✓',
            'Verify domain: x = 32 > 0 ✓',
            'Solution is valid'
        ],
        helper: 'Convert log equation to exponential form',
        solution: 'x = 32',
        realWorldContext: 'Solving for unknowns in logarithmic scales'
    });

    // Problem 10: Natural Exponential
    relatedProblems.push({
        difficulty: 'harder',
        scenario: 'Natural Exponential Function',
        problem: 'Solve: e^(2x) = 50',
        parameters: { exponent: 2, result: 50 },
        type: 'natural_exponential',
        context: { difficulty: 'intermediate', topic: 'Natural Exponential e^x' },
        subparts: [
            'Given: e^(2x) = 50',
            'Take natural log of both sides:',
            'ln(e^(2x)) = ln(50)',
            'Apply property: ln(e^a) = a',
            '2x = ln(50)',
            '2x = 3.912',
            'x = ln(50)/2',
            'x = 3.912/2',
            'x ≈ 1.956',
            'Check: e^(2·1.956) = e^3.912 ≈ 50 ✓'
        ],
        helper: 'Use natural log (ln) for base e equations',
        solution: 'x ≈ 1.956',
        realWorldContext: 'Continuous growth and decay models'
    });

    return relatedProblems;
}

// ============== SOLVE EXPONENTIAL RELATED PROBLEMS ==============

function solveExponentialRelatedProblems() {
    const problems = generateRelatedExponentialEquations();
    const solvedProblems = [];

    problems.forEach((problem, index) => {
        console.log(`  Solving Exponential Problem ${index + 1}: ${problem.scenario}`);

        const workbook = new EnhancedExponentialMathematicalWorkbook({
            theme: 'scientific',
        ...
        workbook.solveExponentialProblem({
            equation: equation,
...
async function generateComprehensiveDocument() {
    ...
    documentChildren.push(
        new docx.Paragraph({
            text: 'Linear, Quadratic, Simultaneous, Polynomial, and Exponential Equations',
            spacing: { after: 300 },
            alignment: docx.AlignmentType.CENTER
        })
    );
    ...
    // Part V: Exponential Equations (NEW)
    documentChildren.push(
        new docx.Paragraph({
            text: 'Part V: Exponential Equations (10 Problems)',
            heading: docx.HeadingLevel.HEADING_3,
            spacing: { before: 200, after: 100 }
        })
    );

    const exponentialProblems = generateRelatedExponentialEquations();
    exponentialProblems.forEach((problem, index) => {
        documentChildren.push(
            new docx.Paragraph({
    ...
    // ============== PART I: LINEAR ALGEBRA (Keep existing) ==============
    ...
    // ============== PART II: QUADRATIC ALGEBRA (Keep existing) ==============
    ...
    // ============== PART III: SIMULTANEOUS EQUATIONS (Keep existing) ==============
    ...
    // ============== PART IV: POLYNOMIAL EQUATIONS (Keep existing) ==============
    ...
    // ============== PART V: EXPONENTIAL EQUATIONS (NEW) ==============
    console.log('\nProcessing Part V: Exponential Equations...');
    documentChildren.push(
        new docx.Paragraph({
            text: 'Part V: Exponential Equations',
            heading: docx.HeadingLevel.HEADING_1,
            spacing: { before: 400, after: 300 },
            pageBreakBefore: true
        })
    ...
    const exponentialSolved = solveExponentialRelatedProblems();
    exponentialSolved.forEach((solved, index) => {
        console.log(`  Adding Exponential Problem ${index + 1} to document...`);
    ...
    try {
        ...
        console.log('    - Exponential Equations: 10 problems');
        console.log('\n📖 CONTENT BREAKDOWN:');
        ...
        console.log('  • Part V: Exponential Equations (Problems 32-41)');
        ...
        console.log('\n🆕 NEW EXPONENTIAL SECTION INCLUDES:');
        console.log('  • Simple exponential equations');
        console.log('  • Exponential with logarithms');
        console.log('  • Exponential inequalities');
        console.log('  • Exponential growth and decay models');
        console.log('  • Compound interest problems');
        console.log('  • Half-life decay calculations');
        console.log('  • Logarithmic equations');
        console.log('  • Natural exponential (e^x) problems');
        console.log('='.repeat(80) + '\n');
    } catch (error) {
